...
vim.api.nvim_create_autocmd({ "BufEnter", "BufWinEnter" }, {
  ...
  callback = function() vim.keymap.set("n", "<leader>tr", CompileAndRunCpp, { desc = "ToggleTerm compile and run" }) end,
})
...
vim.api.nvim_create_autocmd({ "BufEnter", "BufWinEnter" }, {
  pattern = { "*.py" },
  desc = "Run python",
  callback = function() vim.keymap.set("n", "<leader>tr", RunPython, { desc = "ToggleTerm compile and run" }) end,
})
